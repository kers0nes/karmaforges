// server.js – KarmaForges v7.0 (Black & White Edition) - FIXED
...
:root{--bg:#000;--surface:#0a0a0a;--surface2:#111;--surface3:#1a1a1a;--border:rgba(255,255,255,0.06);--border2:rgba(255,255,255,0.12);--text:#fff;--text2:rgba(255,255,255,0.7);--text3:rgba(255,255,255,0.4);--accent:#fff;--accent2:rgba(255,255,255,0.1);--radius:12px;--radius2:8px;--transition:0.2s ease}
...
#auth-wrapper{position:fixed;inset:0;background:var(--bg);display:flex;align-items:center;justify-content:center;z-index:9999;padding:20px}
...
.auth-card .logo{font-size:24px;font-weight:800;letter-spacing:-0.5px;margin-bottom:6px}
.auth-card .logo span{color:rgba(255,255,255,0.4)}
...
@media(max-width:768px){.sidebar{display:none}.main{padding:20px 16px}.scripts-grid{grid-template-columns:1fr}.card .flex{flex-direction:column}.card .flex .grow{width:100%;min-width:auto}}
.menu-toggle{display:none;background:none;border:none;color:var(--text);font-size:24px;cursor:pointer}
@media(max-width:768px){.menu-toggle{display:block}.sidebar.open{display:block;position:fixed;inset:0;width:280px;z-index:100;background:var(--bg);border-right:1px solid var(--border);padding-top:60px}.sidebar-overlay{display:none;position:fixed;inset:0;background:rgba(0,0,0,0.8);z-index:99}.sidebar-overlay.open{display:block}}
.sidebar-overlay{display:none}
.mobile-brand{display:none}
@media(max-width:768px){.mobile-brand{display:flex;justify-content:space-between;align-items:center;width:100%}.topbar{flex-direction:column;align-items:stretch !important;gap:12px}.topbar .user{justify-content:space-between}}
::-webkit-scrollbar{width:4px;height:4px}::-webkit-scrollbar-track{background:transparent}::-webkit-scrollbar-thumb{background:var(--border2);border-radius:4px}::-webkit-scrollbar-thumb:hover{background:rgba(255,255,255,0.2)}
</style>
</head>
<body>
<div id="auth-wrapper">
...
console.log('⚫ KarmaForges Black & White loaded');
